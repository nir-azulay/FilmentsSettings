#!/usr/bin/env python3
"""
Generate Inslogic filament profiles for Bambu Lab H2C.
...
FILAMENTS = [
    {
        ...
        "settings": {
            ...
            "temperature_vitrification":        ["65.5"],
    ...
    {
        # Bambu reference: Bambu ASA / Generic ASA on H2C
        "short":         "Inslogic ASA",
        ...
        "settings": {
            ...
            "filament_dev_ams_drying_heat_distortion_temperature": ["98"],
            ...
            "filament_dev_ams_drying_temperature": ["80", "80", "80", "80"],
            "filament_dev_ams_drying_time":     ["4", "4", "4", "4"],
            "filament_dev_chamber_drying_time": ["4"],
    ...
    {
        # Bambu reference: Bambu TPU 95A on H2C
        ...
        "settings": {
            ...
            "filament_dev_ams_drying_heat_distortion_temperature": ["53"],
    ...
    {
        # Bambu reference: Bambu PLA Basic / Generic PLA on H2C
        "short":         "Inslogic Matte PLA",
        "filament_id":   "Pb4d1e07",
        "filament_type": "PLA",
        "nozzles":       ["0.2", "0.4", "0.6", "0.8"],
        "settings": {
    ...
    },
    {
        ...
        "settings": {
            ...
            "temperature_vitrification":        ["60.9"],
            "filament_dev_ams_drying_heat_distortion_temperature": ["53"],
            "nozzle_temperature":               ["230", "230"],
            "nozzle_temperature_initial_layer": ["230", "230"],
            "nozzle_temperature_range_low":     ["205"],
    ...
    {
        # Nebulux — special effect Galaxy PLA
        "short":         "Inslogic Nebulux PLA",
        "filament_id":   "Pi7a8b9c0",
        "filament_type": "PLA",
        "nozzles":       ["0.2", "0.4", "0.6", "0.8"],
        "settings": {
            "filament_density":                 ["1.2225"],
            "temperature_vitrification":        ["60.9"],
            "filament_dev_ams_drying_heat_distortion_temperature": ["54.6"],

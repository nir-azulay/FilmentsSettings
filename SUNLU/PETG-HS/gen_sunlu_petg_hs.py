...
FILAMENTS = [
    {
        ...
        "settings": {
            ...
            "filament_dev_ams_drying_temperature": ["65", "65", "65", "65"],
    ...
    },
    {
        ...
        # TPU 95A — TDS: 190-230°C, bed 50-60°C, density 1.21
        ...
        "settings": {
            ...
            "filament_dev_ams_drying_temperature": ["55", "55", "55", "55"],
            "filament_dev_ams_drying_time":    ["12", "12", "12", "12"],
            "filament_dev_chamber_drying_time":["12"],
            "filament_max_volumetric_speed":   ["6", "12"],
            "filament_retraction_length":      ["1.0", "1.0"],
            "filament_retraction_speed":       ["35", "35"],
            "filament_deretraction_speed":     ["35", "35"],
            "fan_max_speed":                   ["100"],
    ...
    },
    {
        ...
        "settings": {
            ...
            "filament_dev_ams_drying_heat_distortion_temperature": ["119"],
            "filament_dev_drying_softening_temperature": ["135"],
